...
@FileSystemInfo(type = "fstypegoeshere", // ([a-z0-9]+ only)
		description = "File system description goes here", factory = testEnvoieAssembleurFileSystem.MyFileSystemFactory.class)
public class testEnvoieAssembleurFileSystem implements GFileSystem {
	 ...
	 */
	public testEnvoieAssembleurFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + testEnvoieAssembleurFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryByteProvider<testEnvoieAssembleurFileSystem>,
			GFileSystemProbeByteProvider {

		@Override
		public testEnvoieAssembleurFileSystem create(FSRLRoot targetFSRL,
				ByteProvider byteProvider, FileSystemService fsService, TaskMonitor monitor)
				throws IOException, CancelledException {

			testEnvoieAssembleurFileSystem fs = new testEnvoieAssembleurFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
